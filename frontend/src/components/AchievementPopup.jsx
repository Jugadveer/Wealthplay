...
const AchievementPopup = ({ achievement, onClose, onNotified }) => {
  ...
  return (
    <div className="fixed top-4 right-4 z-[9999] animate-slide-in-right">
      <div className="bg-retro-surface rounded-xl shadow-2xl border border-brand-1/20 p-6 max-w-sm animate-bounce-in shadow-[0_0_20px_rgba(90,167,113,0.15)]">
        <div className="flex items-start gap-4">
          <div className="w-16 h-16 rounded-full bg-brand-1/10 border border-brand-1/20 flex items-center justify-center flex-shrink-0">
            <Icon className="w-8 h-8 text-brand-1" />
          </div>
