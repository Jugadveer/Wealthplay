...
const ScenarioPlay = () => {
  ...
  return (
    <div className="min-h-screen bg-retro-bg">
      {}
      <div className="bg-retro-surface border-b border-brand-1/20 shadow-sm sticky top-0 z-40">
        <div className="max-w-container mx-auto px-6 py-4 flex items-center justify-between">
          <button
            onClick={() => navigate('/scenario')}
            className="flex items-center gap-2 px-4 py-2 rounded-lg text-text-main hover:bg-brand-1/20 transition-colors"
          >
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="w-32 h-2 bg-brand-1/10 rounded-full overflow-hidden">
              <div
      ...
      <div className="max-w-container mx-auto px-6 py-10 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            {}
            <div className="bg-retro-surface rounded-xl p-6 text-text-main shadow-lg border border-brand-1/20">
              ...
              {selectedOption && selectedOption.impact?.balance !== undefined && (
                <div className={`text-sm mt-2 ${selectedOption.impact.balance < 0 ? 'text-accent-red' : 'text-brand-2'}`}>
            ...
            <div className="bg-retro-surface/80 rounded-xl p-6 shadow-card border border-brand-1/20">
              ...
              {selectedOption && showResult && (
                <div className={`text-sm mt-2 ${isCorrect ? 'text-accent-green' : 'text-text-muted/60'}`}>
          ...
          <div className="lg:col-span-1">
            {scenario && (
              <div className="bg-retro-surface/80 rounded-xl p-8 shadow-card border border-brand-1/20">
                      ...
                      <button
                        ...
                        className={`w-full p-6 rounded-xl border-2 text-left transition-all duration-180 ${
                          isSelected
                            ...
                            : 'border-brand-1/20 bg-retro-surface hover:border-brand-1/50 hover:shadow-md'
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            {selectedOption && selectedOption.impact && (
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-retro-surface/80 rounded-xl p-6 shadow-card text-center border border-brand-1/20">
                ...
                <div className="bg-retro-surface/80 rounded-xl p-6 shadow-card text-center border border-brand-1/20">
                  ...
                  <div className={`text-2xl font-bold ${
                    ...
                    (selectedOption.impact.risk || 0) < 60 ? 'text-brand-2' : 'text-accent-red'
                  }`}>
            ...
            {showResult && selectedOption && (
              <div className="bg-gradient-to-br from-brand-2/15 to-brand-1/10 rounded-xl p-6 border-2 border-brand-2/30 shadow-card animate-[modalEnter_360ms_ease-out_forwards]">
                <div className="flex items-center gap-2 mb-4">
                  <Zap className="w-5 h-5 text-brand-2" />
                ...
                <div className={`text-sm font-semibold mb-4 ${
                  isCorrect ? 'text-accent-green' : 'text-text-muted/60'
                }`}>
                  You earned +{isCorrect ? (selectedOption?.score || 0) : 0} Points
                  {!isCorrect && (
                    <span className="block text-xs text-text-muted/50 mt-1">No points for incorrect answer</span>
                  )}
                </div>
                ...
                {selectedOption?.content?.mentor && (
                  <div className="mt-4 p-3 bg-brand-1/10 rounded-lg border-l-4 border-brand-1">
                    <p className="text-sm font-semibold text-brand-1 mb-1">Mentor Feedback:</p>
