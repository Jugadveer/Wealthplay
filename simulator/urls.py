...
from . import paper_trading_views
...
urlpatterns = [
    ...
    path('api/quiz/<int:run_id>/complete/', api_views.complete_quiz_api, name='complete_quiz_api'),
    ...
    path('api/portfolio/', paper_trading_views.get_portfolio, name='get_portfolio'),
    path('api/trade/', paper_trading_views.trade_asset, name='trade_asset'),
    path('api/portfolio-analytics/', paper_trading_views.portfolio_analytics, name='portfolio_analytics'),
]